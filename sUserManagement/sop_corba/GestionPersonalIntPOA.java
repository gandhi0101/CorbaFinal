...
/**
* sUserManagement/sop_corba/GestionPersonalIntPOA.java .
...
public abstract class GestionPersonalIntPOA extends org.omg.PortableServer.Servant
 implements sUserManagement.sop_corba.GestionPersonalIntOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         sUserManagement.sop_corba.personalDTO objPersonal = sUserManagement.sop_corba.personalDTOHelper.read (in);
       ...
       {
         int id = in.read_long ();
         sUserManagement.sop_corba.personalDTOHolder objPersonal = new sUserManagement.sop_corba.personalDTOHolder ();
         boolean $result = false;
         $result = this.consultarPersonal (id, objPersonal);
         out = $rh.createReply();
         out.write_boolean ($result);
         sUserManagement.sop_corba.personalDTOHelper.write (out, objPersonal.value);
         break;
       }

       case 2:  // sop_corba/GestionPersonalInt/registrarUsuario
       {
         sUserManagement.sop_corba.usuarioDTO objUsuario = sUserManagement.sop_corba.usuarioDTOHelper.read (in);
         org.omg.CORBA.BooleanHolder res = new org.omg.CORBA.BooleanHolder ();
       ...
       {
         int id = in.read_long ();
         sUserManagement.sop_corba.usuarioDTOHolder objUsuario = new sUserManagement.sop_corba.usuarioDTOHolder ();
         boolean $result = false;
         $result = this.consultarUsuario (id, objUsuario);
         out = $rh.createReply();
         out.write_boolean ($result);
         sUserManagement.sop_corba.usuarioDTOHelper.write (out, objUsuario.value);
         break;
       }

       case 4:  // sop_corba/GestionPersonalInt/abrirSesion
       {
         sUserManagement.sop_corba.credencialDTO objCredencial = sUserManagement.sop_corba.credencialDTOHelper.read (in);
         boolean $result = false;
       ...
       {
         sUserManagement.sop_corba.AdmCllbckInt objCllbck = sUserManagement.sop_corba.AdmCllbckIntHelper.read (in);
       ...
       {
         sUserManagement.sop_corba.FapCllbckInt objCllbck = sUserManagement.sop_corba.FapCllbckIntHelper.read (in);
