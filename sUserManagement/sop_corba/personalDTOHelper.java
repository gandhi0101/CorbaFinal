...
/**
* sUserManagement/sop_corba/personalDTOHelper.java .
...
abstract public class personalDTOHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, sUserManagement.sop_corba.personalDTO that)
  {
  ...
  public static sUserManagement.sop_corba.personalDTO extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (sUserManagement.sop_corba.personalDTOHelper.id (), "personalDTO", _members0);
          __active = false;
        }
      }
    }
  ...
  public static sUserManagement.sop_corba.personalDTO read (org.omg.CORBA.portable.InputStream istream)
  {
    sUserManagement.sop_corba.personalDTO value = new sUserManagement.sop_corba.personalDTO ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, sUserManagement.sop_corba.personalDTO value)
  {
